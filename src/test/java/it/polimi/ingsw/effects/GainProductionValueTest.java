...
public class GainProductionValueTest {
	...
	@Test
	public void testGainProductionValue() {
		GainProductionValue gain=new GainProductionValue(1);
		assertEquals(1,gain.productionValue);
	}
