...
public class PutRelativeOnTowerDoublePrivilegeDoubleCard extends Observable<Change> implements PutRelative {
	...
	public PutRelativeOnTowerDoublePrivilegeDoubleCard(Player player, Tower tower, int floor, Relative relative, Tower secondT,
			int secondF, String bonus, String secondBonus, int match) {
	...
	public void apply(Play play)
		...
		if (isApplicable()) {
			...
			secondCardToGive.applyPrivilegeBonus(play, player, secondBonus);
